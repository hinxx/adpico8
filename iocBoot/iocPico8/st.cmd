...
#    6=NDFloat32
#    7=NDFloat64
Pico8Configure("$(PORT)", "/dev/amc_pico_0000:0a:00.0", $(YSIZE), 6, 0, 0, 0, 0)
...
dbLoadRecords("$(PICO8)/db/pico8N.template", "P=$(PREFIX),R=det1:3:,PORT=$(PORT),ADDR=2,TIMEOUT=1,NAME=$(T3)")
dbLoadRecords("$(PICO8)/db/pico8N.template", "P=$(PREFIX),R=det1:4:,PORT=$(PORT),ADDR=3,TIMEOUT=1,NAME=$(T4)")
dbLoadRecords("$(PICO8)/db/pico8N.template", "P=$(PREFIX),R=det1:5:,PORT=$(PORT),ADDR=4,TIMEOUT=1,NAME=$(T5)")
dbLoadRecords("$(PICO8)/db/pico8N.template", "P=$(PREFIX),R=det1:6:,PORT=$(PORT),ADDR=5,TIMEOUT=1,NAME=$(T6)")
